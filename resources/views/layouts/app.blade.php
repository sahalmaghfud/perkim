...
<head>
    ...
    <style>
        ...
        @keyframes slideBackground {
            ...
            /* Tahan gambar pertama selama beberapa detik */
            0%,
            45% {
            ...
            /* Transisi ke gambar kedua */
            50% {
                opacity: 0.5;
            }

            /* Tahan gambar kedua selama beberapa detik */
            55%,
            100% {
        ...
        #background-slider {
            ...
            /* Jalankan animasi 'slideBackground' selama 14 detik, berulang terus-menerus */
    ...
    <div id="app-container" class="relative min-h-screen">
        ...
        <aside id="sidebar"
            ...
            <div class="p-5 text-center border-b border-gray-200 sidebar-header">
                ...
                <h2 class="text-xl font-semibold mt-2 nav-text">SIPANDA</h2>
                <p class="text-sm text-gray-500 nav-text">Sistem Manajemen Surat & Dokumen</p>
            ...
            <nav class="py-5">
                <a href="/dashboard"
                    class="flex items-center py-3 px-5 border-l-4 transition-all duration-300 {{ request()->is('dashboard') ? 'border-indigo-600 bg-indigo-50 text-indigo-700 font-semibold' : 'border-transparent text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}">
                    ...
                    <div
                        ...
                        <div class="relative">
                            <a href="#" data-toggle="sub-dropdown"
                                class="flex items-center justify-between py-2.5 px-5 pl-12 text-sm text-gray-500 hover:bg-gray-200 hover:text-gray-800 transition-all duration-300">
                                <span class="flex items-center">
                            ...
                            <div
                                class="sub-dropdown-menu max-h-0 overflow-hidden bg-gray-100 transition-all duration-300 ease-in-out">
                                <a href="/sekertariat/dokumen?search=&kategori=Surat+Masuk&bidang_id=4"
                                    class="block py-2 px-5 pl-16 text-sm text-gray-600 hover:bg-gray-300">Surat
                                    Masuk</a>
                        ...
                        <div class="relative">
                            ...
                            <div
                                ...
                                <a href="/sekertariat/dokumen?search=&kategori=Register+SP2D&bidang_id=4"
                                    class="block py-2 px-5 pl-16 text-sm text-gray-600 hover:bg-gray-300">Register
                                    SP2D</a>
                                <a href="/sekertariat/laporan?search=&kategori=BKU&bidang_id=2"
                                    class="block py-2 px-5 pl-16 text-sm text-gray-600 hover:bg-gray-300">BKU</a>
                            </div>
                        </div>
                    </div>
                </div>
