        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" name="nama"
                    ...
                    placeholder="Nama Perumahan" value="{{ $siteplan->nama ?? old('nama') }}">
            </div>
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" name="nama_pt"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Nama PT" value="{{ $siteplan->nama_pt ?? old('nama_pt') }}">
            </div>
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" name="tipe"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Tipe" value="{{ $siteplan->tipe ?? old('tipe') }}">
            </div>
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="text" name="jenis"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Jenis (e.g., MBR / Komersil)" value="{{ $siteplan->jenis ?? old('jenis') }}">
            </div>

            <div class="col-span-12 md:col-span-4">
                <label for="jumlah_unit_rumah" class="block text-sm font-medium text-gray-700 mb-1">Jumlah Unit
                    Rumah:</label>
                <input type="number" name="jumlah_unit_rumah"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Jumlah Unit" value="{{ $siteplan->jumlah_unit_rumah ?? old('jumlah_unit_rumah') }}">
            </div>
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <input type="number" name="tahun"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="YYYY" value="{{ $siteplan->tahun ?? old('tahun') }}">
            </div>

            <div class="col-span-12 md:col-span-4">
                <label for="sumber_air_bersih" class="block text-sm font-medium text-gray-700 mb-1">Sumber Air
                    Bersih:</label>
                <input type="text" name="sumber_air_bersih"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Sumur Gali/Bor/PDAM"
            ...
            <div class="col-span-12">
                ...
                <textarea
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm h-24"
                    name="alamat" placeholder="Alamat">{{ $siteplan->alamat ?? old('alamat') }}</textarea>
            </div>
...
<div class="bg-white shadow-md rounded-lg border border-gray-200 mt-6">
    ...
    <div class="p-6">
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 md:col-span-4">
                <label for="luas_lahan_per_unit" class="block text-sm font-medium text-gray-700 mb-1">Luas Lahan Per
                    Unit:</label>
                <input type="text" name="luas_lahan_per_unit"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Contoh: 6x12"
                    value="{{ $siteplan->luas_lahan_per_unit ?? old('luas_lahan_per_unit') }}">
            </div>
            <div class="col-span-12 md:col-span-4">
                <label for="luas_lahan_perumahan" class="block text-sm font-medium text-gray-700 mb-1">Luas Lahan
                    Perumahan (m²):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                ...
                <input type="number" step="0.01" name="luas_psu"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="0.00" value="{{ $siteplan->luas_psu ?? old('luas_psu') }}">
            </div>
            <div class="col-span-12 md:col-span-4">
                <label for="panjang_prasarana_jalan" class="block text-sm font-medium text-gray-700 mb-1">Panjang
                    Prasarana Jalan (m):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="lebar_prasarana_jalan" class="block text-sm font-medium text-gray-700 mb-1">Lebar
                    Prasarana Jalan (m):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="luas_prasarana_jalan" class="block text-sm font-medium text-gray-700 mb-1">Luas Prasarana
                    Jalan (m²):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="luas_prasarana_drainase" class="block text-sm font-medium text-gray-700 mb-1">Luas
                    Prasarana Drainase (m²):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="luas_prasarana_rth" class="block text-sm font-medium text-gray-700 mb-1">Luas Prasarana
                    RTH (m²):</label>
                <input type="number" step="0.01" name="luas_prasarana_rth"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="0.00" value="{{ $siteplan->luas_prasarana_rth ?? old('luas_prasarana_rth') }}">
            </div>
            <div class="col-span-12 md:col-span-4">
                <label for="luas_prasarana_tps" class="block text-sm font-medium text-gray-700 mb-1">Luas Prasarana
                    TPS (m²):</label>
                <input type="number" step="0.01" name="luas_prasarana_tps"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="0.00" value="{{ $siteplan->luas_prasarana_tps ?? old('luas_prasarana_tps') }}">
            </div>
            <div class="col-span-12 md:col-span-4">
                <label for="luas_sarana_pemakaman" class="block text-sm font-medium text-gray-700 mb-1">Luas Sarana
                    Pemakaman (m²):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="luas_sarana_olahraga_dll" class="block text-sm font-medium text-gray-700 mb-1">Luas Sarana
                    Olahraga/Lainnya (m²):</label>
            ...
            <div class="col-span-12 md:col-span-4">
                <label for="panjang_utilitas" class="block text-sm font-medium text-gray-700 mb-1">Panjang Utilitas
                    (m):</label>
                <input type="text" name="panjang_utilitas"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Listrik, air, dll"
...
<div class="bg-white shadow-md rounded-lg border border-gray-200 mt-6">
    ...
    <div class="p-6">
        <div class="grid grid-cols-12 gap-6">
            <div class="col-span-12 md:col-span-6">
                <label for="nomor_site_plan" class="block text-sm font-medium text-gray-700 mb-1">Nomor Site
                    Plan:</label>
                <input type="text" name="nomor_site_plan"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Nomor Site Plan" value="{{ $siteplan->nomor_site_plan ?? old('nomor_site_plan') }}">
            </div>
            <div class="col-span-12 md:col-span-6">
                <label for="tanggal_site_plan" class="block text-sm font-medium text-gray-700 mb-1">Tanggal Site
                    Plan:</label>
                <input type="date" name="tanggal_site_plan"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    value="{{ $siteplan->tanggal_site_plan ?? null ? $siteplan->tanggal_site_plan->format('Y-m-d') : old('tanggal_site_plan') }}">
            </div>
            <div class="col-span-12 md:col-span-6">
                <label for="nomor_bast_adm" class="block text-sm font-medium text-gray-700 mb-1">Nomor BAST
                    Administrasi:</label>
                <input type="text" name="nomor_bast_adm"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Nomor BAST Adm" value="{{ $siteplan->nomor_bast_adm ?? old('nomor_bast_adm') }}">
            </div>
            <div class="col-span-12 md:col-span-6">
                <label for="tanggal_bast_adm" class="block text-sm font-medium text-gray-700 mb-1">Tanggal BAST
                    Administrasi:</label>
                <input type="date" name="tanggal_bast_adm"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    value="{{ $siteplan->tanggal_bast_adm ?? null ? $siteplan->tanggal_bast_adm->format('Y-m-d') : old('tanggal_bast_adm') }}">
            </div>
            <div class="col-span-12 md:col-span-6">
                <label for="nomor_bast_fisik" class="block text-sm font-medium text-gray-700 mb-1">Nomor BAST
                    Fisik:</label>
                <input type="text" name="nomor_bast_fisik"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder="Nomor BAST Fisik"
                    value="{{ $siteplan->nomor_bast_fisik ?? old('nomor_bast_fisik') }}">
            </div>
            <div class="col-span-12 md:col-span-6">
                <label for="tanggal_bast_fisik" class="block text-sm font-medium text-gray-700 mb-1">Tanggal BAST
                    Fisik:</label>
                <input type="date" name="tanggal_bast_fisik"
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
            ...
            <div class="col-span-12">
                ...
                <textarea
                    class="block w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm h-20"
                    name="keterangan" placeholder="Jatuh Tempo/Proses/Selesai">{{ $siteplan->keterangan ?? old('keterangan') }}</textarea>
            </div>
        </div>
    </div>
</div>
<div class="col-span-12">
    <label for="file_path" class="block text-sm font-medium text-gray-700 mb-1">Upload File Site Plan
        (PDF/Gambar):</label>

    {{-- Tampilkan file yang ada jika form edit --}}
    @if (isset($siteplan) && $siteplan->file_path)
        <div class="mb-2 text-sm">
            <span>File saat ini:</span>
            <a href="{{ asset('storage/' . $siteplan->file_path) }}" target="_blank"
