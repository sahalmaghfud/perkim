    ...
    <div class="space-y-8">
        ...
        <div class="bg-white shadow-lg rounded-xl border border-slate-200">
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $siteplan->nama) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nama_pt" id="nama_pt" value="{{ old('nama_pt', $siteplan->nama_pt) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2">
                </div>
                <div class="sm:col-span-2">
                ...
                <div>
                    <label for="kecamatan" class="block text-sm font-medium text-slate-700 mb-1">Kecamatan</label>
                ...
                <div>
                    <label for="desa" class="block text-sm font-medium text-slate-700 mb-1">Desa/Kelurahan</label>
                ...
                <div>
                    ...
                    <input type="text" name="jenis" id="jenis" value="{{ old('jenis', $siteplan->jenis) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2"
                ...
                <div>
                    <label for="tipe" class="block text-sm font-medium text-slate-700 mb-1">Tipe <span
                            class="text-red-500">*</span></label>
                    <input type="text" name="tipe" id="tipe" value="{{ old('tipe', $siteplan->tipe) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2"
                ...
                <div>
                    ...
                    <input type="number" name="tahun" id="tahun" value="{{ old('tahun', $siteplan->tahun) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2"
                        placeholder="YYYY">
                </div>
            </div>
        ...
        <div class="bg-white shadow-lg rounded-xl border border-slate-200">
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <div>
                    <label for="luas_lahan_perumahan" class="block text-sm font-medium text-slate-700 mb-1">Total Luas
                        Lahan (m²)</label>
                    <input type="number" step="0.01" name="luas_lahan_perumahan" id="luas_lahan_perumahan"
        ...
        <div class="bg-white shadow-lg rounded-xl border border-slate-200">
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    <label for="tanggal_site_plan" class="block text-sm font-medium text-slate-700 mb-1">Tanggal Site
                        Plan</label>
                ...
                <div>
                    <label for="tanggal_bast_adm" class="block text-sm font-medium text-slate-700 mb-1">Tanggal BAST
                        Administrasi</label>
                ...
                <div>
                    <label for="tanggal_bast_fisik" class="block text-sm font-medium text-slate-700 mb-1">Tanggal BAST
                        Fisik</label>
        ...
        <div class="bg-white shadow-lg rounded-xl border border-slate-200">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    <label for="panjang_prasarana_jalan" class="block text-sm font-medium text-slate-700 mb-1">Panjang
                        Jalan (m)</label>
                    <input type="number" step="0.01" name="panjang_prasarana_jalan" id="panjang_prasarana_jalan"
                        value="{{ old('panjang_prasarana_jalan', $siteplan->panjang_prasarana_jalan) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2">
                </div>
                <div>
                    <label for="lebar_prasarana_jalan" class="block text-sm font-medium text-slate-700 mb-1">Lebar
                        Jalan (m)</label>
                    <input type="number" step="0.01" name="lebar_prasarana_jalan" id="lebar_prasarana_jalan"
                        value="{{ old('lebar_prasarana_jalan', $siteplan->lebar_prasarana_jalan) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2">
                </div>
                <div>
                    <label for="luas_prasarana_jalan" class="block text-sm font-medium text-slate-700 mb-1">Luas Jalan
                        (m²)</label>
                    <input type="number" step="0.01" name="luas_prasarana_jalan" id="luas_prasarana_jalan"
                        value="{{ old('luas_prasarana_jalan', $siteplan->luas_prasarana_jalan) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2">
                </div>
                <div>
                    <label for="luas_prasarana_drainase" class="block text-sm font-medium text-slate-700 mb-1">Luas
                        Drainase (m²)</label>
                    <input type="number" step="0.01" name="luas_prasarana_drainase" id="luas_prasarana_drainase"
                ...
                <div>
                    <label for="luas_sarana_pemakaman" class="block text-sm font-medium text-slate-700 mb-1">Luas
                        Pemakaman (m²)</label>
                    <input type="number" step="0.01" name="luas_sarana_pemakaman" id="luas_sarana_pemakaman"
                        value="{{ old('luas_sarana_pemakaman', $siteplan->luas_sarana_pemakaman) }}"
                        class="block w-full border-2 border-slate-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors duration-200 px-3 py-2">
                </div>
                <div>
                    <label for="luas_sarana_olahraga_dll" class="block text-sm font-medium text-slate-700 mb-1">Luas
                        Olahraga/Dll (m²)</label>
                ...
                <div>
                    <label for="panjang_utilitas" class="block text-sm font-medium text-slate-700 mb-1">Panjang
                        Utilitas</label>
                ...
                <div>
                    <label for="sumber_air_bersih" class="block text-sm font-medium text-slate-700 mb-1">Sumber Air
                        Bersih</label>
    ...
    <div class="flex justify-between items-center pt-6">
        <a href="{{ route('siteplans.index') }}"
            class="inline-flex items-center justify-center px-6 py-3
               ...
               font-semibold text-xs text-slate-700 uppercase tracking-widest
               shadow-sm hover:bg-slate-50 hover:border-slate-400 hover:-translate-y-px
        ...
        <button type="submit"
            class="inline-flex items-center justify-center px-6 py-3
               bg-midnight_green-500 border border-transparent rounded-lg
               font-semibold text-xs text-white uppercase tracking-widest
               shadow-md hover:bg-midnight_green-600 hover:shadow-lg hover:-translate-y-px
               focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ecru-500
               active:bg-midnight_green-600
               transition-all duration-150 ease-in-out">
